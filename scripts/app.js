
                ]
            }
        },
        {
            ...
            "properties": {
                "warId": "WAR_MG",
                "routeType": "invasion",
                "name": "9. 몽골군 수안 침공로 (1253)",
                "description": "수안 지역 몽골군 침공 경로",
                "stroke": "#00FF00",
                "stroke-width": 3
            },
            "geometry": {
                "type": "LineString",
                "coordinates": [
                    [126.021, 38.105], [126.019, 38.104], [126.017, 38.103], [126.015, 38.102],
                    [126.013, 38.101], [126.011, 38.100], [126.009, 38.099], [126.007, 38.098],
                    [126.005, 38.097], [126.003, 38.096], [126.001, 38.095], [125.999, 38.094]
                ]
            }
        },
        {
            ...
            "properties": {
                "warId": "WAR_MG",
                "routeType": "invasion",
                "name": "10. 몽골군 나주 침공로 (1254)",
                "description": "나주 지역 몽골군 침공 경로",
                "stroke": "#00FF00",
                "stroke-width": 3
            },
            "geometry": {
                "type": "LineString",
                "coordinates": [
                    [126.711, 34.989], [126.709, 34.988], [126.707, 34.987], [126.705, 34.986],
                    [126.703, 34.985], [126.701, 34.984], [126.699, 34.983], [126.697, 34.982],
                    [126.695, 34.981], [126.693, 34.980], [126.691, 34.979], [126.689, 34.978]
                ]
            }
        },
        {
            ...
            "properties": {
                "warId": "WAR_MG",
                "routeType": "invasion",
                "name": "11. 몽골군 동경 침공로 (1258)",
                "description": "동경(경주) 지역 몽골군 침공 경로",
                "stroke": "#00FF00",
                "stroke-width": 3
            },
            "geometry": {
                "type": "LineString",
                "coordinates": [
                    [129.365, 35.856], [129.363, 35.855], [129.361, 35.854], [129.359, 35.853],
                    [129.357, 35.852], [129.355, 35.851], [129.353, 35.850], [129.351, 35.849],
                    [129.349, 35.848], [129.347, 35.847], [129.345, 35.846], [129.343, 35.845]
                ]
            }
        },
        {
            ...
            "properties": {
                "warId": "WAR_MG",
                "routeType": "invasion",
                "name": "12. 몽골군 전주 침공로 (1254)",
                "description": "전주 지역 몽골군 침공 경로",
                "stroke": "#00FF00",
                "stroke-width": 3
            },
            "geometry": {
                "type": "LineString",
                "coordinates": [
                    [127.148, 35.824], [127.146, 35.823], [127.144, 35.822], [127.142, 35.821],
                    [127.140, 35.820], [127.138, 35.819], [127.136, 35.818], [127.134, 35.817],
                    [127.132, 35.816], [127.130, 35.815], [127.128, 35.814], [127.126, 35.813]
                ]
            }
        },
        {
            ...
            "properties": {
                "warId": "WAR_MG",
                "routeType": "invasion",
                "name": "13. 몽골군 합천 침공로 (1254)",
                "description": "합천 지역 몽골군 침공 경로",
                "stroke": "#00FF00",
                "stroke-width": 3
            },
            "geometry": {
                "type": "LineString",
                "coordinates": [
                    [128.165, 35.567], [128.163, 35.566], [128.161, 35.565], [128.159, 35.564],
                    [128.157, 35.563], [128.155, 35.562], [128.153, 35.561], [128.151, 35.560],
                    [128.149, 35.559], [128.147, 35.558], [128.145, 35.557], [128.143, 35.556]
                ]
            }
        },
        {
            ...
            "properties": {
                "warId": "WAR_MG",
                "routeType": "resistance",
                "name": "14. 삼별초 항쟁 경로 1 (1270-1273)",
                "description": "삼별초의 대몽항쟁 이동 경로",
                "stroke": "#0000FF",
                "stroke-width": 3
            },
            "geometry": {
                "type": "LineString",
                "coordinates": [
                    [126.561, 33.512], [126.559, 33.511], [126.557, 33.510], [126.555, 33.509],
                    [126.553, 33.508], [126.551, 33.507], [126.549, 33.506], [126.547, 33.505],
                    [126.545, 33.504], [126.543, 33.503], [126.541, 33.502], [126.539, 33.501]
                ]
            }
        },
        {
            ...
            "geometry": {
                "type": "LineString",
                "coordinates": [
                    [126.271, 34.315], [126.269, 34.314], [126.267, 34.313], [126.265, 34.312],
                    [126.263, 34.311], [126.261, 34.310], [126.259, 34.309], [126.257, 34.308],
                    [126.255, 34.307], [126.253, 34.306], [126.251, 34.305], [126.249, 34.304]
                ]
            }
        },
        {
            ...
            "properties": {
                ...
                "routeType": "invasion",
                "name": "거란의 1차 침입로 (소손녕)",
                "description": "압록강을 건너 흥화진, 귀주를 지나 안융진까지 진격. 서희의 담판으로 철수. [교과서 82쪽]",
                "stroke": "#FF0000",
                "stroke-width": 3
            },
            "geometry": {
        ...
        },
        {
            ...
            "properties": {
                "warId": "WAR_KH",
                "routeType": "invasion",
                "name": "거란의 2차 침입로 (강조의 정변)",
                "description": "흥화진을 우회하여 통주에서 승리, 서경을 지나 개경까지 함락 후 철수. [교과서 82쪽]",
                "stroke": "#FF0000",
                "stroke-width": 3
            },
            "geometry": {
        ...
        },
        {
            ...
            "properties": {
                ...
                "routeType": "invasion",
                "name": "거란의 3차 침입로 (소배압)",
                "description": "개경 부근까지 깊숙이 침입했다가 퇴각 중 귀주에서 강감찬에게 섬멸당함. [교과서 82쪽]",
                "stroke": "#FF0000",
                "stroke-width": 3
            },
            "geometry": {
        ...
        },
        {
            ...
            "properties": {
                "warId": "WAR_MG",
                "routeType": "invasion",
                "name": "1. 몽골군 북방 진입로 (압록강~남경)",
                "description": "압록강에서 시작하여 귀주, 서경(평양), 개경을 지나 남경(서울) 분기점까지 내려오는 메인 루트 [교과서 86쪽]",
                "stroke": "#FF0000",
                "stroke-width": 4
            },
            "geometry": {
        ...
        },
        {
            ...
            "properties": {
                "warId": "WAR_MG",
                "routeType": "invasion",
                "name": "2. 서남권 분기 침입로 (남경→나주)",
                "description": "남경에서 갈라져 나와(좌측), 처인성, 직산, 공주, 전주를 거쳐 나주까지 이어지는 호남 공략 루트 [교과서 86쪽]",
                "stroke": "#FF0000",
                "stroke-width": 3
            },
            "geometry": {
        ...
        },
        {
            ...
            "properties": {
                "warId": "WAR_MG",
                "routeType": "invasion",
                "name": "3. 동남권 분기 침입로 (남경→경주)",
                "description": "남경에서 갈라져 나와(우측), 광주, 죽주, 충주를 거쳐 상주, 대구, 경주(황룡사)까지 이어지는 영남 공략 루트 [교과서 86쪽]",
                "stroke": "#FF0000",
                "stroke-width": 3
            },
            "geometry": {
        ...
        },
        {
            ...
            "properties": {
                "warId": "WAR_MG",
                "routeType": "invasion",
                "name": "4. 충청 내륙 횡단로 (청주~충주)",
                "description": "서남권 루트(청주 인근)와 동남권 루트(충주) 사이를 잇는 횡단 이동로 [교과서 86쪽]",
                "stroke": "#FF0000",
                "stroke-width": 2
            },
            "geometry": {
        ...
        },
        {
            ...
            "properties": {
                "warId": "WAR_MG",
                "routeType": "resistance",
                "name": "5. 삼별초 이동로 (강화→진도)",
                "description": "강화도에서 출발하여 서해안을 따라 남하, 진도 용장성에 도착하는 해상 경로 [교과서 86쪽]",
                "stroke": "#0000FF",
                "stroke-width": 3
            },
            "geometry": {
        ...
        },
        {
            ...
            "properties": {
                "warId": "WAR_MG",
                "routeType": "resistance",
                "name": "6. 삼별초 이동로 (진도→제주)",
                "description": "진도 함락 후 남해를 건너 제주 항파두리로 이동하는 해상 경로 [교과서 86쪽]",
                "stroke": "#0000FF",
                "stroke-width": 3
            },
            "geometry": {
                    ...
                    const newLayer = L.geoJSON(filteredData, {
                        ...
                        onEachFeature: function (feature, layer) {
                            if (feature.properties && (feature.properties.NAME || feature.properties.name)) {
                                ...
                                // 클릭 이벤트 - 그리기 모드가 아닐 때만 동작
                                layer.on('click', function (e) {
                                    // 그리기 모드 중이면 클릭 이벤트 무시
                                    if (isFreehandDrawing || isEraserActive || currentDrawHandler) {
...
function showBattleMarkers(year) {
    ...
    // 활성화된 전쟁의 침공 루트 표시
    activeWarIds.forEach(warId => {
        const routes = INVASION_ROUTES.features.filter(feature => feature.properties.warId === warId);
        
        routes.forEach(route => {
            const routeType = route.properties.routeType || 'invasion';
            const strokeColor = route.properties.stroke || '#dc2626';
            
            // 루트 타입에 따른 색상 설정 (침공: 빨강, 저항: 파랑)
            const lineColor = routeType === 'resistance' ? '#2563eb' : strokeColor;
            const arrowColor = routeType === 'resistance' ? '#1e40af' : '#991b1b';
            const fillColor = routeType === 'resistance' ? '#3b82f6' : strokeColor;
            const titleColor = routeType === 'resistance' ? '#2563eb' : '#dc2626';
            const titleIcon = routeType === 'resistance' ? '🛡️' : '🗡️';
            
            let routeLayer;
            
            // Geometry 타입에 따라 다른 레이어 생성
            if (route.geometry.type === 'Polygon') {
                // Polygon 형식 (전투 지역 영역)
                const polygonCoords = route.geometry.coordinates[0].map(coord => [coord[1], coord[0]]);
                routeLayer = L.polygon(polygonCoords, {
                    color: route.properties.stroke || lineColor,
                    weight: route.properties['stroke-width'] || 2,
                    opacity: 0.8,
                    fillColor: route.properties.fill || fillColor,
                    fillOpacity: route.properties['fill-opacity'] || 0.3,
                ...
                routeLayer.bindPopup(
                    `<div style="font-family: sans-serif; padding: 12px; min-width: 250px;">
                        <h3 style="margin: 0 0 8px 0; font-size: 16px; color: ${titleColor}; font-weight: 700;">${titleIcon} ${route.properties.name}</h3>
                        <p style="margin: 0; font-size: 13px; color: #374151; line-height: 1.5;">${route.properties.description}</p>
                    </div>`,
                    {
                        className: 'custom-popup',
                        offset: [0, 0]
                ...
                eventMarkers.push(routeLayer);
            } else {
                // LineString 형식 (침공 루트 라인)
                const routeLine = L.polyline(
                    route.geometry.coordinates.map(coord => [coord[1], coord[0]]), // [lng, lat] -> [lat, lng]
                    {
                        color: lineColor,
                        weight: 4,
                        opacity: 0.7,
                        dashArray: '10, 10',
                        className: 'invasion-route'
                    }
                ).addTo(map);
...
function convertDrawnItemsToGeoJSON() {
    ...
    // 2. 자유 그리기 중인 임시 도형도 포함 (R키를 누르지 않은 경우)
    if (isFreehandDrawing && freehandSegments.length > 0) {
        try {
            // 모든 세그먼트를 하나의 경로로 합치기
            const allPoints = [];
            freehandSegments.forEach(seg => allPoints.push(...seg));
...
function activateFreehand() {
    ...
    // 지도 드래그 비활성화 (그리기 위해), 줌은 유지
    map.dragging.disable();
    map.doubleClickZoom.disable();
    map.boxZoom.disable();
    // 스크롤 줌과 터치 줌은 활성화 상태 유지하여 확대/축소 가능하게 함
    ...
    // 키보드 이벤트 리스너 (R키로 완료)
    document.addEventListener('keydown', onFreehandKeyDown);
}
...
function deactivateFreehand() {
    ...
    // 키보드 이벤트 리스너 제거
    document.removeEventListener('keydown', onFreehandKeyDown);
}
...
function onFreehandMouseDown(e) {
    ...
    freehandPath = [e.latlng]; // 새로운 세그먼트의 첫 점
    ...
    if (!freehandPolyline) {
        ...
        freehandPolyline = L.polyline(allPoints, {
...
function onFreehandMouseMove(e) {
    if (!isFreehandDrawing || !isDrawingSegment) return;

    // 현재 세그먼트 경로에 점 추가
    freehandPath.push(e.latlng);

    // 임시 선 업데이트 (전체 경로 + 현재 세그먼트)
    if (freehandPolyline) {
        const allPoints = [];
        freehandSegments.forEach(seg => allPoints.push(...seg));
        allPoints.push(...freehandPath);
        freehandPolyline.setLatLngs(allPoints);
    }
}

// 마우스 업 이벤트
function onFreehandMouseUp(e) {
    if (!isFreehandDrawing || !isDrawingSegment || freehandPath.length < 2) {
        isDrawingSegment = false;
        return;
    }
    ...
    // 현재 세그먼트를 저장
    freehandSegments.push([...freehandPath]);
    
    // 현재 세그먼트 초기화 (다음 세그먼트 준비)
    freehandPath = [];
    isDrawingSegment = false;
...
// R키 이벤트 (자유 그리기 완료 및 저장)
function onFreehandKeyDown(e) {
    if (!isFreehandDrawing) return;
    
    if (e.key === 'r' || e.key === 'R') {
        // 저장할 세그먼트가 있는지 확인
        if (freehandSegments.length === 0) return;
        ...
        // 부드럽게 만들기
        const smoothPath = smoothFreehandPath(allPoints);
        ...
        // 세그먼트 초기화 (새로운 도형 시작 준비)
        freehandSegments = [];
        freehandPath = [];
        isDrawingSegment = false;
        
        console.log('자유 그리기 완료! 새로운 도형을 그리거나 R키를 눌러 다시 저장하세요.');
    }
}
